...
$levelQuery=mysqli_query($con,"select * from tbllevel"); //courses
$countAllLevel = mysqli_num_rows($levelQuery);

$semesterQuery=mysqli_query($con,"select * from tblsemester"); //courses
$countAllSemester = mysqli_num_rows($semesterQuery);
...
$lecCountStaff = mysqli_num_rows($query);
