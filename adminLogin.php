...
<!doctype html>
<header id="header" class="fixed-top" style="background-image: linear-gradient(to bottom, blue , skyblue);">
    <div class="container d-flex align-items-center">
        <a class="navbar-brand" href="index.php"><img src="assets/img/student-grade.png" alt="Logo" style="width:70px;height:70px;"></a>
        <h1 class="logo mr-auto" style="font-family: Arial; color:black; font-size:30px;"><a href="index.php" style="color:white;">Bayambang Polytechnic College Management System</a></h1>
...
<body style="background-image:linear-gradient(to right, skyblue , blue, skyblue);">
                ...
                <div class="login-form">
                    <form method="Post" Action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="staffId" Required class="form-control" placeholder="Username">
                        </div>
                        <div class="form-group">
