...
<header id="header" class="fixed-top" style="background-image: linear-gradient(to bottom, blue , skyblue);">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto" style="font-family: Arial; color:black; font-size:30px;"><a href="index.php" style="color:white;">Bayambang Polythecnic College Management System</a></h1>
                ...
                <div class="login-form">
                    <form method="Post" Action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="matricNo" Required class="form-control" placeholder="Student Number">
                        </div>
                        <div class="form-group">
